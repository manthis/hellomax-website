    ...
    return (
        <div id='content' className='relative z-10 flex w-full origin-left items-center justify-between duration-500'>
            <div className='relative z-50 max-w-[600px]'>
                <h4 className='mb-2 text-2xl font-normal tracking-widest text-lightblue landscape:text-lg '>Hello,</h4>
                <h2 className='text-7xl leading-[1em] text-white landscape:text-5xl'>I&apos;m Max</h2>
                <h3 className='text-3xl font-light leading-[1.5em] text-white landscape:text-xl'>
