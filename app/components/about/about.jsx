...
const About = () => {
    return (
        <section
            id='about'
            className='xl:bg-background2 relative flex min-h-[100svh] w-full items-center justify-center overflow-hidden bg-darkblue bg-cover bg-fixed bg-center bg-no-repeat py-0 '>
            <div className='flex min-h-[100svh] w-full justify-center backdrop-blur backdrop-grayscale'>
                {/* */}
                <div className='z-40 rounded-2xl bg-darkblue px-[40px] py-20 text-justify opacity-95 xl:my-40 xl:w-2/3 xl:px-[100px] '>
