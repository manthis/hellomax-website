...
export default function ContactZone() {
    ...
    return (
        <ul
            id='contactzone'
            className='fixed bottom-[20px] z-50 flex justify-start xl:bottom-[40px] landscape:w-[calc(100%-80px)] landscape:justify-end landscape:xl:w-[calc(100%-200px)] landscape:2xl:justify-start'>
